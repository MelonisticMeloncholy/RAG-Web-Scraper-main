...
# --- Test Data ---
TEST_CRAWL_URL = "https://seths.blog/" # Updated URL
TEST_MAX_PAGES = 5
TEST_MAX_DEPTH = 1
TEST_CRAWL_DELAY_MS = 200

# Questions tailored for a blog about marketing/business insights
ANSWERABLE_QUESTION = "What is a common theme or advice Seth Godin gives about marketing?"
UNANSWERABLE_QUESTION = "What is the square root of pi?"
...
class TestRunner:
    ...
    def test_crawl_and_index(self):
        ...
        logger.info(f"\n--- Running Crawl and Index Test for {TEST_CRAWL_URL} ---")
        endpoint = f"{BASE_URL}/crawl"
        payload = {
            "start_url": TEST_CRAWL_URL,
...
if __name__ == "__main__":
    ...
    # It's good practice to close DB connections explicitly, especially in test setup/teardown
    try:
